      ...
      <div className="w-full max-w-2xl">
        <Card className="shadow-2xl rounded-2xl">
          ...
          <CardContent className="text-center text-muted-foreground space-y-4">
            ...
            <p>
              Em poucos minutos, você receberá o acesso completo ao método em seu email, junto com bônus especiais que vão acelerar ainda mais os resultados. Prepare-se para se emocionar com os primeiros "mamãe, eu consegui ler!" do seu filho - porque essa conquista está muito mais próxima do que você imagina.
            </p>
